                            ...
                            <div class="col-sm">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">
                                        ...
                                        <a class="btn btn-success" href="manage-users.php">
                            ...
                            <div class="col-sm-4">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">
                                        ...
                                        <a class="btn btn-success" href="manage-doctors.php">
                            ...
                            <div class="col-sm-4">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">
                                        ...
                                        <!-- <a class="btn btn-success" href="book-appointment.php"> -->
                                        <a class="btn btn-success" href="appointment-history.php">
                            ...
                            <div class="col-sm-4">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">
                                        ...
                                        <a class="btn btn-success" href="manage-patient.php">
